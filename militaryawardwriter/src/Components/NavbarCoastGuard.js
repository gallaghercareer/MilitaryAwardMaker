...
function NavbarCoastGuard(props) {
  ...
  return (
    <AppBar ref={navbarRef}position="fixed" elevation={0} style={{ zIndex:20,top:0, height: '10dvh', backgroundColor: 'white', borderBottom: '1px solid #e0e0e0'  }}>
    <Toolbar>
...
export default NavbarCoastGuard;
